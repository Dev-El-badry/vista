...
<a class="btn btn-primary"  href="{{ route('job_title.create') }}">
	...
	<div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title" style="color: #f00">Manage Job Titles</h3>
        ...
        <div class="box-body">
			...
			echo JobTitleController::get_sortable_list($data['status']); 
			?>
