...
@section('content')
<h1><i class="fa fa-plus"></i> &nbsp;Add New Compliant Title</h3></h1>
{{-- Start Section Add Title --}}
<div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-gear"></i> &nbsp;Add New Compliant Title</h3>
  </div><!-- /.box-header -->
	...
	@endif
  	...
  	<form action="{{ route('compliant_title.store') }}" method="POST">
  	{{ csrf_field() }}
    <div class="box-body">
