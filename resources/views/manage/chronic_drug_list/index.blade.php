...
<div class="manage_title">
	...
	Manage Chronic Drug  Titles
	</h1>
</div>


<a class="btn btn-primary"  href="{{ route('chronic_drug_list.create') }}">
	<i class="fa fa-plus"></i>
	Add New Chronic Drug  Title
</a>
	...
	<div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title" style="color: #f00">Manage Chronic Drug Titles</h3>
        ...
        <div class="box-body">
			...
			echo ChronicDrugListController::get_sortable_list($data['status']); 
			?>
