...
<div class="manage_title">
	...
	Manage Cronic Disease Categories
	</h1>
</div>


<a class="btn btn-primary"  href="{{ route('cronic_disease_category.create') }}">
	<i class="fa fa-plus"></i>
	Add New Cronic Disease Category
</a>
	...
	<div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title" style="color: #f00">Manage Cronic Disease Categories</h3>
        ...
        <div class="box-body">
			...
			echo ChronicDiseaseCategoryController::get_sortable_list($data['row_id'], $data['status']); 
			?>
...
@php
	...
	$first_bit = 'cronic_disease_category';
