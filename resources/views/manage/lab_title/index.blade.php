...
<a class="btn btn-primary"  href="{{ route('lab_title.create') }}">
	...
	<div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title" style="color: #f00">Manage Lab Titles</h3>
        ...
        <div class="box-body">
			...
			echo LabController::get_sortable_list($data['status']); 
			?>
